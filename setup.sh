...
echo ""
echo "  Next steps:"
echo "  1. Close this terminal and relaunch Wibey: wibey"
echo "  2. Type: /custom/sarthi"
echo "     sArthI auto-detects first run and guides you if anything needs attention."
echo ""
echo "  Available commands (type in Wibey):"
echo "  /custom/sarthi              → start sArthI"
echo "  /custom/sarthi monitor      → DAG health dashboard"
echo "  /custom/sarthi sync         → sync team knowledge"
echo "  /custom/sarthi setup        → run health check"
echo ""
